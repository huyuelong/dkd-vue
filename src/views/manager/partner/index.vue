  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['manager:partner:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['manager:partner:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manager:partner:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['manager:partner:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="300">
        <template #default="scope">
          <el-button link type="primary" @click="resetPwd(scope.row)" v-hasPermi="['manager:partner:edit']">重置密码</el-button>
          <el-button link type="primary" @click="getPartnerInfo(scope.row)" v-hasPermi="['manager:partner:query']">查看详情</el-button>
          <el-button link type="primary" @click="handleUpdate(scope.row)" v-hasPermi="['manager:partner:edit']">修改</el-button>
          <el-button link type="primary" @click="handleDelete(scope.row)" v-hasPermi="['manager:partner:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listPartner, getPartner, delPartner, addPartner, updatePartner, resetPartnerPwd } from "@/api/manager/partner";
...
function resetPwd(row) {
  const _id = row.id;
  proxy.$modal.confirm('你确定要重置该合作商密码码？').then(function() {
...
function handleExport() {
  proxy.download('manager/partner/export', {
    ...queryParams.value
